const workorders = [
    {
        ...
        faults_and_remarks: [
            `Piduriklotsid läbi`,
            `vasak tagumine amort loksuga`
        ],
        client_representative:  "German Mumma",
        work_receiver: "Sander Laiv",
        work_performer: "Sander Laiv",
        consent: [
